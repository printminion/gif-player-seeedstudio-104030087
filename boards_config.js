...
window.COMPONENTS_CONFIG = [
  { name: "Seeed Studio Round Display for XIAO", description: "1.28\" round touch display with SD card slot — GC9A01 driver, CST816S touch IC", sku: "104030087", url: "https://www.seeedstudio.com/1-28-Round-Touch-Display-for-Seeed-Studio-XIAO-ESP32.html?sensecap_affiliate=unUJe6L&referring_service=link", image: "assets/components/round_display_xiao.jpg" }
];
...
window.PROJECT_CONFIG = {
  ...
  projectName:        "gif-player-seeedstudio-104030087",
  projectDescription: "Animated GIF player for Seeed Studio XIAO ESP32-S3 with 1.28\" round touch display (SKU 104030087)"
};
